...
<!-- Here we can see Adams' reference to terror is more in line with the idea of a fearsome government like the "Reign of
Terror" that had just occurred in France earlier that decade. While this is likely not how a modern president would use the word, it still feels topical given the issues nations were struggling to face at the time. -->
...
<!-- One more interesting part to observe is that President Garfield's speech had an end total of 0 on the positivity scale. This is largely due to how his speech praised how proud he was of his nation, but condemned any acts he saw as a threat to it (namely the impediment of African-American suffrage). -->
